...
const HERO = "https://images.unsplash.com/photo-1519162952575-c6c7199502a3?crop=entropy&cs=srgb&fm=jpg&q=85&w=1600";
    ...
    <div className="space-y-8 tt-fade-in" data-testid="dashboard-page">
      ...
      >
        ...
        <div className="relative p-6 md:p-12 flex flex-col justify-end h-full" style={{ minHeight: 320 }}>
          <div className="tt-overline text-[#FF3B30] mb-3">Le command center du tennis de table</div>
          <h1 className="font-heading text-5xl md:text-7xl leading-none mb-4">
            CHAQUE MATCH.<br />CHAQUE POINT.<br />EN TEMPS RÉEL.
          </h1>
          <p className="text-zinc-300 text-lg max-w-xl">
            ITTF, WTT, Pro A, Bundesliga, Chinese Super League — toutes les compétitions, tous les classements, prédictions IA incluses.
          </p>
